...
_LLM_MODELS: list[ModelEntry] = [
    ModelEntry(
        ...
        priority="H",
        in_cri_plan=True,
        notes="MLA + MoE (256 experts, top-8, 1 shared), 78 layers",
    ),
    ModelEntry(
        name="Step-3.5-Flash",
        hf_id=None,
    ...
    ModelEntry(
        ...
        hf_ids=["deepseek-ai/DeepSeek-V4-Pro",
        ...
        priority="H",
        in_cri_plan=True,
        notes="MLA + MoE (384 experts, top-6, 1 shared), grouped output, 61 layers",
    ),
    ModelEntry(
        name="DeepSeek-R1",
